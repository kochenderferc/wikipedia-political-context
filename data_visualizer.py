...
plt.figtext(0.5, 0.01, f"Figure 1:  Count of edits made to english Wikipedia by country from registered accounts, N={total_edit_count}", ha="center", fontsize=9, style="italic")
